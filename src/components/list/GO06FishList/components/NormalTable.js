...
const NormalTable = ({
  ...
  const expandList = ["ordinaryFish", "specialFish", "particularFish"];
                  ...
                  <div className="tr" key={v[0]}>
                    <div className="td">
                      <img
                        className="fish-img"
                        src={`
${imgsdomain}/order-detail/common/GO06/${v[0]}.png`}
                      />
                    </div>
                    {title !== "weaponFish" && (
                      <div className="td">
                        {ratios.getIn(["GO06", v[0], "ratio"]).map((v, k) => (
                          <p key={k}>{v}</p>
                        ))}
                      </div>
                    )}
                ...
                <div className="title-area">
                  <div className="title">
                    ...
                    <img
                      className="fish-img"
                      src={`
${imgsdomain}/order-detail/common/GO06/${popupList.getIn([0, "fishId"])}.png`}
                    />
                  </div>
                  <div
                    className="close"
