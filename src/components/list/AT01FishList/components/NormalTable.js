...
const NormalTable = ({
  ...
  const moreMultiplierList = ["21", "22", "26", "27", "28", "23", "29"];
  const specialFishesOnlyList = ["21", "22", "26", "27"];
                  ...
                  <div className="tr" key={v[0]}>
                    <div className="td">
                      <img
                        className="fish-img"
                        src={`
${imgsdomain}/order-detail/common/AT01_v2/${v[0]}.png`}
                      />
                    </div>
                    {title !== "weaponFish" && (
                      <div className="td">
                        {ratios.getIn(["AT01", v[0], "ratio"]).map((v, k) => (
                          <p key={k}>{v}</p>
                        ))}
                      </div>
                    )}
