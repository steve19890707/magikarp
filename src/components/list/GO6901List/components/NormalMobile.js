      ...
      <NormalMobileWrapper>
        <div className="img">
          <img
            className="fish-img"
            src={`
            ${imgsdomain}/order-detail/common/GO6901/${fish[0]}.png`}
          />
        </div>
        ...
        <Table>
          {title !== "weaponFish" && (
            <div className="tr">
              <h5>{t("multiplier")}</h5>
              <p>
                {ratios.getIn(["GO6901", fish[0], "ratio"]).map((v, k) => (
                  <span key={k}>{v}</span>
                ))}
              </p>
            </div>
            ...
            <div className="title-area">
              <div className="title">
                ...
                <img
                  className="fish-img"
                  src={`
                  ${imgsdomain}/order-detail/common/GO6901/${popupList.getIn([
                    0,
                    "fishId",
                  ])}.png`}
                />
              ...
              {popupList.map((item, idx) => {
                ...
                return (
                  <div className="popup-item" key={idx}>
                    ...
                    <div className="tr">
                      <h5>{t("normalKills")}</h5>
                      <p>{item.get("KillCount")}</p>
                    </div>
                    <div className="tr">
                      <h5>{t("electricKills")}</h5>
                      <p>{item.getIn(["WeaponKillCounts", "2"]) || 0}</p>
                    </div>
                    <div className="tr">
                      <h5>{t("payout")}</h5>
                      <p>{wins}</p>
