...
const NormalTable = ({
  ...
  const fishIdSpacielCase = (id = "29") => {
    const langChecked = langChecking();
    switch (id) {
      case "29":
        return `${id}_${langChecked}`;
      default:
        return id;
    }
  };
              ...
              {list.map((v) => {
                ...
                for (let i = 0; i < arrayInfos.size; i++) {
                  kills =
                    ...
                    (arrayInfos.getIn([i, 1, "CannonSkillKillCounts"])
                      ? arrayInfos.getIn([i, 1, "CannonSkillKillCounts"])
                      : 0);
                ...
                return (
                  <div className="tr" key={v[0]}>
                    <div className="td">
                      <img
                        className="fish-img"
                        src={`${imgsdomain}/order-detail/common/AT05_v2/${fishIdSpacielCase(
                          v[0]
                        )}.png`}
                      />
                    </div>
          ...
          {list.map((item, idx) => {
            return (
              <NormalMobile
                ...
                fishIdSpacielCase={fishIdSpacielCase}
