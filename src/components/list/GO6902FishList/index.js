...
import GO6902AntesSelectBar from "components/list/GO6902AntesSelectBar";
...
export default ({ data, list = List() }) => {
  ...
  // GO6902 關卡參數
  const stageType = list.get("StageType") || 1;
